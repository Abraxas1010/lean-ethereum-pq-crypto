...
/-- Placeholder for computational security properties (e.g. target collision resistance).

This is intentionally left abstract, mirroring `Crypto.Signature.Spec.Scheme.SecurityProps`. -/
